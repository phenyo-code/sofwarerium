...
export async function GET() {
  ...
  const pages = [
    ...
    { url: '/home', lastmod: '2025-04-02', changefreq: 'weekly', priority: '1.0' },
    ...
    // Project Pages (from Featured Projects in Home)
    ...
    { url: '/projects/react-lab', lastmod: '2025-04-02', changefreq: 'monthly', priority: '0.5' },
